...
pub struct GpuBuilder {
    ...
    pub source_buffers: Vec<Arc<crate::buffer::GpuBuffer>>,
    ...
    pub(crate) cur_inputs: Vec<StepInput>,
    cur_started: bool,
    ...
    pub(crate) cur_output_adapter: Option<StepInput>,
    ...
    pub(crate) write_wraps: Vec<ResolvedWrap>,
...
impl GpuBuilder {
    ...
    pub fn input(
        ...
        buf: Arc<crate::buffer::GpuBuffer>,
    ) -> &mut Self {
...
/// Maps a [`crate::Storage`] to the Slang `IStorageCodec` type the
...
impl GpuStorageCodec for crate::Storage {
    fn gpu_codec(&self) -> &'static str {
        match self {
            crate::Storage::U8 => "U8Codec",
            crate::Storage::U16 => "U16Codec",
            crate::Storage::F16 => "F16Codec",
            crate::Storage::F32 => "F32Codec",
        }
    }
}

/// Maps a [`crate::ColorModel`] to the Slang `ColorModel` enum
...
impl GpuModelId for crate::ColorModel {
    fn gpu_model(&self) -> u32 {
        use crate::ColorModel as M;
        match self {
            M::Rgb => 0,
            M::Gray => 1,
            M::Cmyk => 2,
...
/// Maps a [`crate::TransferFn`] to the Slang `TransferFn`
...
impl GpuTransferId for crate::TransferFn {
    fn gpu_transfer(&self) -> u32 {
        *self as u32
    }
}

/// Maps a [`crate::AlphaState`] to the Slang `AlphaPolicy` enum value
...
impl GpuAlphaId for crate::AlphaState {
    fn gpu_alpha(&self) -> u32 {
        self.to_shader()
    }
}

impl chromors_core::Backend for GpuBackend {
    type Ctx = GpuContext;
    ...
    fn materialize(
        ...
        root: &std::sync::Arc<crate::Node<GpuBackend>>,
        wu: &WorkUnit,
    ) -> Result<crate::Buffer<GpuBackend>, Error> {
        crate::pass::gpu_materialize(ctx, root, wu)
    }
}

impl chromors_core::Builder<GpuBackend> for GpuBuilder {
    ...
    fn finish(
        ...
        let slang = crate::emit::emit_slang(&self, self.ctx.wg_dim);
        if std::env::var("CHROMORS_DUMP_SLANG").is_ok() {
            eprintln!("{slang}");
        }
        let hash = crate::emit::hash_slang(&slang);
