...
use crate::pixel::{Component, Pixel};
use half::f16;
use wide::f32x4;
...
impl std::ops::Mul<f32> for Rgba<f32> {
    type Output = Self;
...
impl std::ops::Div<f32> for Rgba<f32> {
    type Output = Self;
...
impl std::ops::Add<f32> for Rgba<f32> {
    type Output = Self;
...
impl std::ops::Sub<f32> for Rgba<f32> {
    type Output = Self;
